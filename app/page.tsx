const pipeline = [
  ...
  { step: "PixelShuffle Head", detail: "\u00d72 / \u00d74 super-resolution" },
...
const checks = [
  ...
  "run.py output: float32, (H,W), finite, in [0,1] \u2014 compliant on out-of-range and odd-shaped inputs",
  "Composite loss backward pass verified",
  "Sanity training loop runs and saves models/model.pt",
]
